...
export const metadata: Metadata = {
  ...
  description:
    "Automatic Backend Detection - Autonomous telemetry ingestion, unsupervised Isolation Forest anomaly detection, pgvector RAG, and automated AI self-healing root-cause diagnostics.",
  icons: {
    icon: "/logo-icon.svg",
